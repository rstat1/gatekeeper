...
type LocalAppConfig struct {
	...
	GatekeeperAddr      string `json:"gatekeeperAddr"`
	CacheServerAddr     string `json:"redisAddr"`
	...
	S3CredsSecretName   string `json:"s3CredsSecretName"`
...
func CommonProcessInit(dev, loadConfig bool) {
	...
	if loadConfig {
		...
		Config = LocalAppConfig{
			...
			CacheServerAddr:    os.Getenv("REDIS_ADDR"),
